...
function SidebarDesktopTablet() {
  ...
  return (
    <div
      className={`rounded-tr-[32px] rounded-br-[32px] bg-white transition-all duration-300 ${isOpen ? 'min-w-[250px] lg:min-w-[362px]' : 'min-w-[80px]'} `}
    >
      <div className={`flex h-screen flex-col justify-between ${isOpen ? 'p-4 lg:p-8' : 'px-6 py-8'} `}>
