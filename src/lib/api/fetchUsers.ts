...
export type DeleteCurrentUserRequest =
  NonNullable<operations['deleteMe']['requestBody']>['content']['application/json'];
export type PatchCurrentUserPasswordRequest = operations['changePassword']['requestBody']['content']['application/json'];
